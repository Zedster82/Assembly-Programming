...
my_byte_array BYTE 1,2,3,4,5,6,7,8,9 ; this an array of bytes 10 bytes
my_dword_array DWORD 1,2,3,4,5,6,7,8,9 ;this is an array of DWORDS 40
my_var DWORD 99 ; this is DWORD variable 4
